...
`* *` | user | remove a tag to a person | categorise persons into groups
`* *` | user | edit an existing tag | rename tags to my own preferences
`* *` | user | list all existing tags | view all categories of persons
...
4. AddressBook requests confirmation from the user for the changes.
...
4a. User cancels request to edit
...
5. Should have a UI that is easy to use.
6. Should respond to commands quickly.
